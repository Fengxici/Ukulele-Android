...
class SkinSlidingTabLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0) : SlidingTabLayout(context, attrs, defStyleAttr), SkinCompatSupportable {
    ...
    private fun applySlidingTabLayoutResources() {
